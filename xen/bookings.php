    ...
    <body class="bg-light">
        ...
        <div class="container">
            <div class="row">
                ...
                <?php 
                    ...
                    ((bo.booking_status='booked') OR (bo.booking_status='canceled') OR (bo.booking_status='payment failed'))
        ...
        <?php 
            ...
            if(isset($_GET['cancel_status'])){
                ...
                alert('success','Thank for rating & reviewing!');
            }
