...
let contacts_form = document.getElementById('contacts_s_form');
...
contacts_form.addEventListener('submit',function(e){
    e.preventDefault();
    upd_contacts(site_title_inp.value,site_about_inp.value);
})
...
function upd_contacts(site_title_val,site_about_val)
{
