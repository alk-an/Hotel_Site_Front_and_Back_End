...
<body class="bg-light">
    ...
    <?php 
        ...
        $current_bookings = mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(CASE WHEN booking_status='booked' AND arrival=0 THEN 1 END)
         AS `new_bookings`, COUNT(CASE WHEN booking_status='canceled' AND refund=0 THEN 1 END) AS `refund_bookings` FROM `booking_order`"));
        ...
        $current_users = mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(id) AS `total`, COUNT(CASE WHEN `status`=1 THEN 1 END) AS `active`,
          COUNT(CASE WHEN `status`=0 THEN 1 END) AS `inactive`, COUNT(CASE WHEN `is_verified`=0 THEN 1 END) AS `unverified` FROM `user_cred`"));
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-primary p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="total_amt"></h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-warning p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="pending_amt">0 €</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-success p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="active_amt">0 €</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-danger p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="canceled_amt">0 €</h1>
                        </div>
                    </div>
