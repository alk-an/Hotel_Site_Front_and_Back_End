    ...
    <body class="bg-light">
            ...
            <div class="row">
                ...
                <?php
                    ...
                    while($room_data = mysqli_fetch_assoc($room_res)){
                        ...
                        $fea_q = mysqli_query($con,"SELECT f.name FROM `features` f INNER JOIN
                            `room_features` rfea ON f.id = rfea.features_id WHERE rfea.room_id = '$room_data[id]'");
                        ...
                        $fac_q = mysqli_query($con,"SELECT f.name FROM `facilities` f INNER JOIN
        ...
        <div class="container">
            <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
                ...
                ?>
                <div class="com-lg-12 text-center mt-5">
                    <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Facilities >>></a>
                </div>
            </div>
        </div>
        <!-- telos Our Facilities -->
        ...
        <div class="container mt-5">
            <div class="swiper swiper-reviews">
                <div class="swiper-wrapper mb-5">
                  <?php
                    ...
                    $review_q = "SELECT rr.*, uc.name AS uname, uc.profile, r.name AS rname FROM `rating_review` rr INNER JOIN
                    `user_cred` uc ON rr.user_id = uc.id INNER JOIN `rooms` r ON rr.room_id = r.id ORDER BY `sr_no` DESC LIMIT 6";
            ...
            <div class="com-lg-12 text-center mt-5">
                <a href="about.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Reviews >>></a>
            </div>
        </div>
        <!-- telos Reviews -->
                                ...
                                echo<<<data
                                    <a href="$contact_r[tw]" class="d-inline-block mb-3">     
                                        <span class="badge bg-light text-dark fs-6 p-2">
                                            <i class="bi bi-twitter-x me-1"></i>(former Twitter)
                                        </span>
                                    </a>
                                data;
                            }
