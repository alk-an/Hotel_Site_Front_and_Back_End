                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="profile" type="file" accept=".jpeg, .png, .webp" class="form-control shadow-none" required>
                            </div>
