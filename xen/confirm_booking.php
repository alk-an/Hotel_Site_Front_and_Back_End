    ...
    <body class="bg-light">
        ...
        <?php
            ...
            */
            ...
            if(!($_GET['id']) || $settings_r['shutdown']==true){
                redirect('rooms.php');
            }
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 px-4">
                    <?php 
                        ...
                        echo<<<data
                            ...
                            <div class="card p-3 dhadow-sm rounded">
                ...
                <div class="col-lg-5 col-md-12 px-4">
                    <div class="card mb-4 border-0 shadow-sm rounded-3">
                        <div class="card-body">
                            <form action="pay_now.php" method="$_POST" id="booking_form">
            ...
            booking_form.addEventListener('submit', (e)=>{
                ...
                xhr.onload = function(){
                    ...
                    if(this.responseText == 'success'){
                        ...
                        alert('error',"Room couldnt be booked");
                    }
                }
                xhr.send(data);
            });
